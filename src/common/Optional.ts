...
/**
 * It's port of Java 8 Optional type.
 */
export class Optional<T> {
     ...
     */
    private static createNotNull<T>(value: T): Optional<T> {
        const result = new Optional<T>()
        result.value = requireNonNull(value)
        return result
    }
    ...
    public static of<T>(value: T): Optional<T> {
        return Optional.createNotNull<T>(value)
    }
    ...
    public static ofNullable<T>(value: T): Optional<T> {
        return isInexact(value) ? Optional.empty<T>() : Optional.of<T>(value)
    }
